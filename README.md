...
### 1. 🤖 Android Phone (Direct APK Download)
...
### 2. 🌐 Live Web App (Android, iOS & Desktop)
...
### 3. 💻 Windows Desktop (Offline Standalone Window)
- Download this repository as a ZIP (Green **`<> Code`** button → **Download ZIP**).
- Double-click **`Install-KalaSetu-Desktop.bat`** to create a desktop shortcut with the official logo that opens in a borderless app window.
